...
public class StandAloneTest 
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.id("userEmail")).sendKeys("sambit.gnit@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Sambit@123");
	...
	//ng-animating 
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(".ta-item:nth-of-type(2)"))));
